Shader "ToyShader/ShadowUnlitObjectTriplanar"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings IN) : SV_Target
            {
                ...
                blend /= dot(blend, 1.0);
                half4 cx = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, IN.coords.yz);
                half4 cy = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, IN.coords.xz);
                half4 cz = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, IN.coords.xy);
